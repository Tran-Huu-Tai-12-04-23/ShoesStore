        ...
        return Object.keys(optionsSelect).map((key) => {
            return (
                <li
                    ...
                    style={{
                        "--color":
                            typeProductActive === optionsSelect[key].id
                                ? theme.colorActive
                                : theme.color,
                        minWidth: "20%",
                        textAlign: "center",
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div
                    className='col-lg-4 col-xl-4 col-md-8 col-8 wrapper_setting_user'
                    style={{
                        color: theme.color,
                        "--color_hover": theme.colorActive,
                    }}
                >
                    ...
                    <Menu
                        ...
                        addStyle={{
                            borderRadius:
                                "var(--primary_border_radius) 0 0 var(--primary_border_radius) ",
                            zIndex: 2,
                            padding: "1.2rem",
                    ...
                    >
                        ...
                        <div className='wrapper_store_item_cart'>
                            {renderCartStore()}
                        </div>
